...
# This uses Mishra et al. 2022 SBGE estimates, 
...
# Does a 4th degree polynomial regression (two peaks) fit better than a 2nd degree polynomial?
#####
...
######
# ... Overall, yes. But, the peak at female-bias does not indicate "moderate" bias, more so strong female-bias.
# additionally, the pattern only appears when using log2FC as an estimate for sex bias. 
# When converted to *delta*, a 4th degree polynomial offers the best fit, but qualitatively, there is no twin peaks pattern.
# Could be a result of differences in quantification methods? 
#     (the fruit fly data used by Cheng and Kirkpatrick 2016 was from a microarray study by Innocenti & Morrow 2010)
